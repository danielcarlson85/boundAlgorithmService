...
namespace WorkoutData.Managers
{
    public class BlobsManager : IBlobManager
    {
        ...
        public async Task<bool> AppendDataInBlob(BlobPathValue pathValue, string textToAppend)
        {
            textToAppend = textToAppend + Environment.NewLine;

            CloudBlobContainer container = cloudBlobClient.GetContainerReference(pathValue.ContainerName.ToLower());
            await container.CreateIfNotExistsAsync();

            CloudAppendBlob appBlob = container.GetAppendBlobReference(pathValue.BlobName.ToLower());
        ...
        public async Task<bool> CreateNewBlobInContainer(BlobPathValue pathValue)
        {
