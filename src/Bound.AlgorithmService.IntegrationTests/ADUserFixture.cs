...
namespace Bound.AlgorithmService.IntegrationTests
{
    public class ADUserFixture
    {
        public IUserService UserService { get; }
        public Microsoft.Graph.User CreatedUser { get; set; }
        public Microsoft.Graph.User DeletedUser { get; set; }
        public Microsoft.Graph.User UpdatedUser { get; set; }
